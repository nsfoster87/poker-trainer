      ...
      <div className="bg-gray-800 rounded-xl p-6 shadow-2xl border border-gray-600">
              ...
              {RANKS.map((rank) => {
                ...
                return (
                  <button
                    ...
                    className={`
                      w-10 h-14 rounded border text-sm font-bold flex flex-col items-center justify-center
        ...
        <div className="flex justify-end gap-3 mt-5">
          ...
          <button
            ...
            className="px-4 py-2 bg-blue-600 hover:bg-blue-500 disabled:bg-gray-600 disabled:text-gray-400 disabled:cursor-not-allowed text-white text-sm font-medium rounded transition-colors cursor-pointer"
          >
            Confirm
          </button>
        </div>
