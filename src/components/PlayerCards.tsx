...
function CardFace({ card }: { card: Card }) {
  return (
    <div className="w-8 h-11 rounded bg-white border border-gray-300 flex flex-col items-center justify-center shadow-sm text-[10px] font-bold leading-none">
...
function CardBack() {
  return (
    <div className="w-8 h-11 rounded bg-gradient-to-br from-blue-700 to-blue-900 border border-blue-500 shadow-sm flex items-center justify-center">
